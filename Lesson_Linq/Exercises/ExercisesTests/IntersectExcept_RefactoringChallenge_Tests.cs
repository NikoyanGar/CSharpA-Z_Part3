...
using Route = ExercisesForPractice.IntersectExcept.Route;
using RoutePoint = ExercisesForPractice.IntersectExcept.RoutePoint;
using Point = ExercisesForPractice.IntersectExcept.Point;
